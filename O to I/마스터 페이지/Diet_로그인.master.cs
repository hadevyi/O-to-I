...
public partial class 첫화면_로그아웃 : System.Web.UI.MasterPage
{
    ...
    protected void ImageButton10_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Response.Redirect("~/Diet/운동방법_로그인.aspx");
    }

    protected void ImageButton11_Click(object sender, ImageClickEventArgs e)
    {

        Response.Redirect("~/Diet/비만도측정_로그인.aspx");
    }
    ...
    {
        Response.Redirect("~/Diet/회원용Diet_로그인.aspx");
    ...
    protected void ImageButton13_Click2(object sender, ImageClickEventArgs e)
    {
        Response.Redirect("~/첫화면/Default2.aspx");
    }
}
